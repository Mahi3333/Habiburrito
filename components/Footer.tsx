...
const Footer: React.FC = () => {
    ...
    return (
        <footer className="w-full relative overflow-hidden bg-gradient-to-b from-brand-black via-brand-night to-black text-brand-cream border-t border-white/5">
            ...
            <div className="max-w-7xl mx-auto px-6 py-18 md:py-22 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 relative z-10">
                <div className="space-y-5">
                    ...
                    <div className="flex gap-3">
                        <Link
                            ...
                            className="w-12 h-12 rounded-full border border-white/10 bg-white/5 flex items-center justify-center text-gray-300 hover:text-brand-black hover:bg-brand-gold hover:border-brand-gold transition-all duration-300"
                        >
                ...
                <div className="space-y-5">
                    ...
                    <div className="space-y-3 text-lg text-gray-200">
                        ...
                        <p className="text-brand-gold font-mono text-lg">+1 (978) 000-0000</p>
            ...
            <div className="border-t border-white/5 py-10 text-center text-gray-300 text-base relative z-10">
                <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-3">
                    <p className="text-lg text-white/80">© {year} Habiburrito — Premium Halal Kitchen</p>
